                                                    ...
                                                    project?.videosrc ? (
                                                        <div className="relative w-full rounded-2xl overflow-hidden" style={{ paddingBottom: '56.25%' }}>
                                                            <iframe
                                                                ...
                                                                src={`https://www.youtube.com/embed/${project.videosrc}`}
                                                        ...
                                                        <Image src={project?.img} alt="" width={500} height={300} className='rounded-xl' />
                                                    )
                                                }
                                            </div>
                                                    ...
                                                    project?.link && project?.underDev ? (<div onClick={handleUnderDevelopmentProject}>
                                                        ...
                                                        <Button
                                                            ...
                                                            onClick={async () => {
                                                                ...
                                                                toast.info("This Project is not Deployed yet.");
                                                            }}
                                                        >
                                                            View Demo
