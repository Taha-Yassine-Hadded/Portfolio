                    ...
                    >
                        <PinContainer title="Project Details" href="https://twitter.com/mannupaaji">
                            <div className="relative flex items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[20vh] lg:h-[30vh] mb-10">
                                <div
                                    className={`relative w-full h-full overflow-hidden rounded-md lg:rounded-3xl ${[1, 2, 3, 4, 5, 6, 7, 8].includes(item.id) ? '' : 'bg-[#13162D]'
                                        }`}
                                >
                                    <Image
                                        src={
                                            [1, 2, 3, 4, 5, 6, 7, 8].includes(item.id) ? item.img : '/bg.png'
                                        }
                                        alt="bgimg"
                                        width={400}
                                        height={300}
